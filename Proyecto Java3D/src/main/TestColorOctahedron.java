...
public class TestColorOctahedron extends Applet implements ActionListener
{
    ...
    class ColorOctahedron extends IndexedTriangleArray
    {
        ...
        {
            super(8, GeometryArray.COORDINATES | GeometryArray.NORMALS | GeometryArray.COLOR_3, 24 | GeometryArray.NORMALS);
