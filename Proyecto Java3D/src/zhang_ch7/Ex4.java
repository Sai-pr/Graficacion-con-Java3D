...
public class Ex4 extends Applet implements ActionListener {
  public static void main(String[] args) {
    new MainFrame(new Ex4(), 640, 300);
  }
  ...
  TextField shx = new TextField();
  TextField shy = new TextField();
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    if ("Transform".equals(cmd)) {
      ...
      } else if ("Shear".equals(cmd)) {
        double x = Double.parseDouble(shx.getText());
        double y = Double.parseDouble(shy.getText());
        Matrix3d mat = new Matrix3d();
        mat.setIdentity();
        mat.setElement(0, 2, x);
        mat.setElement(1, 2, y);
        transform.set(mat);
      }
      transform.get(m);
      mp.set(m);
