 ...
 * @author leand
 */
public class HelloJava3Da1 extends JPanel
{
    ...
    private BranchGroup createSceneGraph()
    {
        ...
        {
            Cylinder cylinderr = new Cylinder();
