...
public class MultiGeomAppV2 extends Applet
{
    ...
    public class Cart extends Shape3D
    {
        ...
        private Geometry cartBodyGeometry(float l, float w, float h)
        {
            ...
            //Mio
            coords[20] = new Point3f(l / 2f, -h / 5f, -w / 3f);
            coords[21] = new Point3f(-l / 2f, -h / 5f, -w / 3f);
            coords[22] = new Point3f(-l / 2f, -h / 5f, w / 3f);
            coords[23] = new Point3f(l / 2f, -h / 5f, w / 3f);
    ...
    {
        Frame frame = new MainFrame(new MultiGeomAppV2(), 256, 256);
